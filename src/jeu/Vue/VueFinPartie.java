...
public class VueFinPartie extends BasicGameState {
	...
	public VueFinPartie(int i, VueCentrale v) {
	...
	public void render(GameContainer c, StateBasedGame gm, Graphics gr)
			throws SlickException {
		// TODO Auto-generated method stub
		gr.drawString("Partie terminée", 50, 50);
		gr.drawString("Entrée pour retourner à l'écran titre", 30, 175);
	}
